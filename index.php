              ...
              <div class="carousel-item <?php echo ($counter===0) ? 'active' : '' ?>" style="height: 100%">
                <div class="row" style="width: 80%;margin: 0 auto;padding-top: 20px">
                  ...
                  <div class="col-md-6 col-sm-12">
                    <a href="<?php echo "/calendar/detail/{$result['id']}"; ?>" style='text-decoration: none;color: inherit;'>
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                  ...
                  <p class="card-text">
                    ...
                    <a href="<?php echo "/calendar/detail/{$result['id']}"; ?>" class="btn btn-primary">View event</a>
